...
const SidebarMobile = ({ totalPending, setSidebarOpen }) => {
    ...
    return (
        <div className="flex flex-col min-h-[300px] bg-[#0A3D62] dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 text-gray-200 w-60 shadow-xl">
                ...
                isActive
                    ...
                    {hasModule(7) && (
                        <div>
                            ...
                            >
                                <span className="flex items-center gap-3">
                                    <GrUserSettings size={18} /> Employee Mgt.
                                </span>
                                {employeeMenuOpen ? (
                                    <IoChevronUp size={16} />
                                ) : (
                ...
                isActive
                    ...
                    {hasModule(10) && (
                        <div>
                            ...
                            >
                                <span className="flex items-center gap-3">
                                    <FaFileDownload size={18} /> Downloadble
                                    Forms
                                </span>
                                {downloadbleMenuOpen ? (
                                    <IoChevronUp size={16} />
