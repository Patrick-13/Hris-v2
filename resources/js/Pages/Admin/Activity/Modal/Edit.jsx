...
export default function Edit({
    ...
    const { data, setData, put, errors, reset } = useForm({
        title_id: activities.title_id || "",
        soNumber: activities.soNumber || "",
        dateFrom: activities.dateFrom || "",
        dateTo: activities.dateTo || "",
        noofHours: activities.noofHours || "",
        type: activities.type || "",
        venue: activities.venue || "",
        description: activities.description || "",
        employees: activities.employees || [],
    });

    const employeesList = activityemployees?.data || activityemployees || [];
    const [selectedEmployees, setSelectedEmployees] = useState(
        activities.employees?.map((e) => e.employee_id) || [],
    );
    ...
    const onSubmit = (e) => {
        ...
        put(route("activity.update", activities.id), {
            preserveScroll: true,
            onSuccess: () => {
                closeModal();
                reset();
