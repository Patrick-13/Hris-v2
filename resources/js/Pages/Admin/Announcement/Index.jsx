...
export default function Index({
    ...
    const [selectedAnnouncement, setSelectedAnnouncement] = useState(
        announcementedits || null
    );

    const handleEditClick = async (announcementId) => {
        try {
            const response = await axios.get(
                `/admin/announcement/${announcementId}/edit`
            );
            setSelectedAnnouncement(response.data); // Set the fetched product data
    ...
    const searchFieldChanged = (field, value) => {
        ...
        router.replace(route("announcement.index"), {
            method: "get",
    ...
    const sortChanged = (name) => {
        ...
        router.get(route("announcement.index"), queryParams);
    };
    ...
    const deleteAnnouncement = (announcement) => {
        ...
        router.delete(route("announcement.destroy", activitytype.id));
    };
