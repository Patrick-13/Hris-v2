...
export default function Edit({ companys, closeModal }) {
    const { data, setData, put, errors, reset } = useForm({
        name: companys.name || "",
        address: companys.address || "",
        contact_number: companys.contact_number || "",
        tel_number: companys.tel_number || "",
        company_email: companys.company_email || "",
    });

    const onSubmit = (e) => {
        e.preventDefault();
        put(route("company.update", companys.id), {
            onSuccess: () => {
                closeModal();
                reset();
            },
