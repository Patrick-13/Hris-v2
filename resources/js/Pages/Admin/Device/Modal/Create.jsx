...
export default function Create({ categories, closeModal }) {
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-3 md:grid-cols-3 gap-6">
                ...
                <div>
                    <InputLabel className="block text-sm font-medium text-gray-700">
                        <span className="text-red-500">*</span>Quantity Property Card
                    </InputLabel>
                    <TextInput
                ...
                <div>
                    <InputLabel className="block text-sm font-medium text-gray-700">
                        <span className="text-red-500">*</span>Quantity Physical Count
                    </InputLabel>
                    <TextInput
