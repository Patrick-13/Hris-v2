...
export default function Index({
    ...
    const [selectedOffice, setSelectedOffice] = useState(officeedit || null);

    const handleEditClick = async (officeId) => {
        try {
            const response = await axios.get(`/admin/office/${officeId}/edit`);
            setSelectedOffice(response.data); // Set the fetched product data
    ...
    const searchFieldChanged = (field, value) => {
        ...
        router.replace(route("office.index"), {
            method: "get",
