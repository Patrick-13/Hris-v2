...
export default function Edit({ auth, offices, employees, closeModal }) {
    ...
    const { data, setData, put, errors, reset } = useForm({
        ...
        civil_status: employees.civil_status || "",
        citizenship: employees.citizenship || "",
        weight: employees.weight || "",
        height: employees.height || "",
        bloodtype: employees.bloodtype || "",
        gsis: employees.gsis || "",
        pagibig_number: employees.pagibig_number || "",
        sss_number: employees.sss_number || "",
        philhealth_number: employees.philhealth_number || "",
        TIN: employees.TIN || "",
        date_hired: employees.date_hired || "",
        emp_status:
            employees.emp_status === null ? null : Number(employees.emp_status),
        employment_status: employees.employment_status || "",
        flexi_type: employees.flexi_type || "",
        in_office:
            employees.in_office === null ? null : Number(employees.in_office),
        daily_rate: employees.daily_rate || "",
        account_no: employees.account_no || "",
        fundtype: employees.fundtype || "",
        charging: employees.charging || "",
        province_office: employees.province_office || "",
        office_id: employees.office_id || [],
    });

    const onSubmit = (e) => {
        e.preventDefault();
        put(route("employee.update", employees.id), {
            onSuccess: () => {
                closeModal();
                reset();
            },
        ...
        <div className="max-h-[100vh] overflow-y-auto px-2">
            ...
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        <InputLabel className="block text-sm font-medium text-gray-700">
                            <span className="text-red-500">*</span>Date Hired
                        </InputLabel>
                        <TextInput
                            name="date_hired"
                            id="date_hired"
                    ...
                    {auth.user.role === "admin" && (
                        <div>
                            <InputLabel className="block text-sm font-medium text-gray-700">
                                <span className="text-red-500">*</span>Sched.
                                Type
                            </InputLabel>
                            <SelectInput
                                name="flexi_type"
