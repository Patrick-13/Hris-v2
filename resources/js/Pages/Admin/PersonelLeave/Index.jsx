...
export default function Index({
    ...
    const searchFieldChanged = (field, value) => {
        ...
        debounceTimeout.current = setTimeout(() => {
            ...
            router.get(route("employeeleaveadmin.index"), updatedQueryParams, {
                preserveState: true,
                tab: "pending",
                only: onlyMap[activeTab],
            });
        }, 300);
    };
    ...
    const changeTab = (tab) => {
        router.get(
            route("employeeleaveadmin.index"),
            {
                ...queryParams,
                tab,
            },
