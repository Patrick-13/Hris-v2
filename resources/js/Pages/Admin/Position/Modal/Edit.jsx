...
export default function Create({ sections, positions, closeModal }) {
    const { data, setData, put, errors, reset } = useForm({
        post_name: positions.post_name || "",
        post_code: positions.post_code || "",
        sec_id: positions.sec_id || "",
    });

    const onSubmit = (e) => {
        e.preventDefault();
        put(route("position.update", positions.id), {
            onSuccess: () => {
                closeModal();
                reset();
            },
