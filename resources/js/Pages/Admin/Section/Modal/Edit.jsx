...
export default function Edit({ employees, divisions, sections, closeModal }) {
    const { data, setData, put, errors, reset } = useForm({
        sec_name: sections.sec_name || "",
        sec_code: sections.sec_code || "",
        div_id: sections.div_id || "",
        sec_immediate_supervisor: sections.sec_immediate_supervisor || "",
    });

    const onSubmit = (e) => {
        e.preventDefault();
        put(route("section.update", sections.id), {
            onSuccess: () => {
                closeModal();
                reset();
            },
