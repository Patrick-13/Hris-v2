...
export default function Index({
    ...
    const handleEditClick = async (typeformId) => {
        try {
            const response = await axios.get(`/user/typeform/${typeformId}/edit`);
            setSelectedTypeform(response.data); // Set the fetched product data
    ...
    const searchFieldChanged = (field, value) => {
        ...
        router.replace(route("typeform.index"), {
            method: "get",
    ...
    const sortChanged = (name) => {
        ...
        router.get(route("typeform.index"), queryParams);
    };

    const deleteForm = (typeform) => {
        if (
            !window.confirm(
                `are you sure you want to delete the ${typeform.name} Form Type?`
            )
        ) {
            return;
        }
        router.delete(route("typeform.destroy", typeform.id));
    };
                            ...
                            <div className="overflow-auto">
                                ...
                                <div className="overflow-x-auto">
                                    <div className="md:h-[400px] lg:h-[500px] overflow-y-auto">
                                        ...
                                        <Pagination
                                            links={
                                                typeforms && typeforms.meta.links
                                            }
