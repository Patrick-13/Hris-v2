...
export default function Edit({ auth, contactdetails, closeModal }) {
    const { data, setData, put, errors, reset } = useForm({
        ...
        barangay: contactdetails.barangay || "",
    ...
    useEffect(() => {
        if (data.city) {
            axios
                .get(`/user/cities/${data.city}/barangays/`)
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        put(route("mycontact.update", contactdetails.id), {
            onSuccess: () => {
                closeModal();
                reset();
            },
