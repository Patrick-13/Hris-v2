...
export default function Edit({ auth, migrations, closeModal }) {
    const { data, setData, put, errors, reset } = useForm({
        employee_id: auth.user.employee_id,
        documentAttachement: migrations.documentAttachement || "",
        number: migrations.number || "",
        issuedBy: migrations.issuedBy || "",
        issuedDate: migrations.issuedDate || "",
        expiryDate: migrations.expiryDate || "",
    });

    const onSubmit = (e) => {
        e.preventDefault();
        put(route("migration.update", migrations.id), {
            onSuccess: () => {
                closeModal();
                reset();
            },
