...
export default function Edit({ auth, workexperiences, closeModal }) {
    const { data, setData, put, errors, reset } = useForm({
        employee_id: auth.user.employee_id,
        dateFrom: workexperiences.dateFrom || "",
        dateTo: workexperiences.dateTo || "",
        jobTitle: workexperiences.jobTitle || "",
        emp_status: workexperiences.emp_status || "",
        isGovernment: workexperiences.isGovernment || false,
        department: workexperiences.department || "",
        agency: workexperiences.agency || "",
        office: workexperiences.office || "",
        company: workexperiences.company || "",
        branch: workexperiences.branch || "",
        leave_absent: workexperiences.leave_absent || "",
        monthysalary: workexperiences.monthysalary || "",
        paycolumngrade: workexperiences.paycolumngrade || "",
        separationCause: workexperiences.separationCause || "",
        isActive: workexperiences.isActive || false,
    });

    const onSubmit = (e) => {
        e.preventDefault();
        put(route("workexperience.update", workexperiences.id), {
            onSuccess: () => {
                closeModal();
                reset();
            },
