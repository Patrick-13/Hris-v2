...
const Resubmitted = ({
    ...
    const handleAccomplishmentClick = async (personnelovertimeId) => {
        try {
            const response = await axios.get(
                `/employeeovertime/${personnelovertimeId}/showaccomplishment`
            );
    ...
    const canBulkApprove = () => {
        ...
        return personnelaccomplishmentresubmitted.data.some(
            (accomplishment) =>
            ...
            <div className="overflow-x-auto">
                <div className="md:h-[700px] lg:h-[700px] overflow-y-auto">
                    <table className="w-full text-sm text-left trl:text-right text-gray-500 dark:text-gray-400">
                                ...
                                <th className="px-3 py-2">
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setSelectedIds(
                                                e.target.checked
                                                    ? personnelaccomplishmentresubmitted.data.map(
                                                          (o) => o.id
                                                      )
                                                    : []
                                            )
                                        ...
                                        checked={
                                            personnelaccomplishmentresubmitted?.data
                                                .length > 0 &&
                                            selectedIds.length ===
                                                personnelaccomplishmentresubmitted.data
                                                    .length
                        ...
                        <tbody>
                            {personnelaccomplishmentresubmitted &&
                            personnelaccomplishmentresubmitted.data.length >
                                0 ? (
                                personnelaccomplishmentresubmitted.data.map(
                    ...
                    <Pagination
                        links={
                            personnelaccomplishmentresubmitted &&
                            personnelaccomplishmentresubmitted.meta.links
                        }
