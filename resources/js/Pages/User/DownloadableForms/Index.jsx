...
export default function Index({
    ...
    const handleEditClick = async (dowloadableformId) => {
        try {
            const response = await axios.get(
                `/user/downloadform/${dowloadableformId}/edit`,
            );
    ...
    const searchFieldChanged = (field, value) => {
        ...
        debounceTimeout.current = setTimeout(() => {
            ...
            router.get(route("downloadform.index"), updatedQueryParams, {
                preserveState: true,
                only: [
                    "downloadableforms",
                    "queryParams",
    ...
    const sortChanged = (name) => {
        ...
        router.get(route("downloadform.index"), queryParams);
    };
    ...
    const deleteDownloadbleform = (downloadableform) => {
        ...
        router.delete(route("downloadform.destroy", downloadableform.id));
    };
                                                ...
                                                downloadableforms.data.map(
                                                    (downloadableform) => (
                                                        ...
                                                        >
                                                            ...
                                                            <td className="px-3 py-2">
                                                                <a
                                                                    href={`/user/downloadableform/${encodeURIComponent(
