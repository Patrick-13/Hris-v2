...
export default function Edit({ formtypes, downloadbleforms, closeModal }) {
    const { data, setData, put, errors, reset } = useForm({
        name: downloadbleforms.name || "",
        description: downloadbleforms.description || "",
        form_type: downloadbleforms.form_type || "",
        dfFile: null,
    });

    const onSubmit = (e) => {
        e.preventDefault();
        put(route("downloadform.update", downloadbleforms.id), {
            forceFormData: true,
            onSuccess: () => {
                closeModal();
                reset();
