...
export default function Create({
    ...
    const { data, setData, put, errors, reset } = useForm({
        employee_id: leavecredits.employee_id || "",
        leave_type_id: leavecredits.leave_type_id || "",
        year: leavecredits.year || "",
        entitled: leavecredits.entitled || "",
        used: leavecredits.used || 0,
        balance: leavecredits.balance || "",
    });
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        put(route("leavecredit.update", leavecredits.id), {
            onSuccess: () => {
                closeModal();
                reset();
            },
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <InputLabel className="block text-sm font-medium text-gray-700">
                            <span className="text-red-500">*</span>Emplyoee Id
                        </InputLabel>
                        <ComboBox
                    ...
                    <div>
                        ...
                        <SelectInput
                            ...
                            onChange={(e) => {
                                ...
                                setData("entitled", entitled); // 👈 auto-set entitlement
                                setData("balance", entitled); // 👈 usually balance starts as entitlement
                            }}
                    ...
                    <div>
                        ...
                        <TextInput
                            ...
                            type="number"
                            value={data.entitled || ""}
                            readOnly // 👈 user cannot edit (remove if you want them to edit)
                    ...
                    <div>
                        ...
                        <TextInput
                            ...
                            className="mt-1 block w-full border-gray-300 rounded-md shadow-sm bg-gray-100"
                        />
                        <InputError message={errors.used} className="mt-2" />
                    </div>
                    <div>
                        <InputLabel className="block text-sm font-medium text-gray-700">
